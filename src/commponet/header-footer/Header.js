...
const Header = () => {
  return (
     <header className="bg-white shadow-md">
      <div className=" mx-auto flex items-center justify-between px-1 py-4 capitalize">
        <h1 className="text-lg font-bold uppercase text-gray-900 hover:text-blue-600 transition">
